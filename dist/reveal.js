  ...
  function $(n, o) {
    ...
    function we() {
      !1 !== H &&
        ...
        A.postMessage && window.addEventListener("message", Et, !1),
        setInterval(() => {
    ...
    function ke() {
      window.addEventListener("resize", At, !1),
        ...
        ue.bind(),
        fe.bind(),
        _.slides.addEventListener("click", Rt, !1),
        _.slides.addEventListener("transitionend", St, !1),
        _.pauseOverlay.addEventListener("click", We, !1),
        A.focusBodyOnPageVisibilityChange &&
          document.addEventListener("visibilitychange", kt, !1);
    }
    function Le() {
      ye.unbind(),
        fe.unbind(),
        ...
        ge.unbind(),
        he.unbind(),
        window.removeEventListener("resize", At, !1),
        _.slides.removeEventListener("click", Rt, !1),
        _.slides.removeEventListener("transitionend", St, !1),
        _.pauseOverlay.removeEventListener("click", We, !1);
    }
    function Ce(e, t, i) {
    ...
    function Te({ target: t = _.wrapper, type: i, data: s, bubbles: a = !0 }) {
    ...
    function Ie(t, i) {
      if (A.postMessageEvents && window.parent !== window.self) {
        let s = { namespace: "reveal", eventName: t, state: ct() };
    ...
    function Me() {
      if (_.wrapper && !oe.isActive()) {
        ...
        if (!A.disableLayout) {
          ...
          Be(A.width, A.height),
            ...
            1 === X || re.isActive()
              ...
              : ((_.slides.style.zoom = ""),
                ...
                Pe({ layout: "translate(-50%, -50%) scale(" + X + ")" }));
          ...
          s !== X &&
            Te({ type: "resize", data: { oldScale: s, scale: X, size: i } });
        }
        !(function () {
          if (
            _.wrapper &&
    ...
    function qe() {
      return !(!v || !ze(v)) && !v.nextElementSibling;
    }
    function Oe() {
      return 0 === c && 0 === h;
    }
    function Ve() {
      return (
        ...
        (!ze(v) || !v.parentNode.nextElementSibling)
      );
    }
    function Ue() {
      if (A.pause) {
    ...
    function We() {
      const e = _.wrapper.classList.contains("paused");
      _.wrapper.classList.remove("paused"), ht(), e && Te({ type: "resumed" });
    }
    function je(e) {
      "boolean" == typeof e ? (e ? Ue() : We()) : Ke() ? We() : Ue();
    }
    function Ke() {
    ...
    function $e(e, i, s, a) {
      ...
      let l = c || 0,
        d = h || 0;
      (c = Je(f, void 0 === e ? c : e)), (h = Je(y, void 0 === i ? h : i));
      let u = c !== l || h !== d;
      u || (g = null);
      let p = r[c],
      ...
      e: for (let e = 0, t = $.length; e < t; e++) {
        ...
        _.viewport.classList.add($[e]), Te({ type: $[e] });
      }
    ...
    function Je(e, i) {
      ...
      if (a) {
        ...
        for (let e = 0; e < a; e++) {
          ...
          t.classList.remove("past"),
            ...
            n
              ? t.classList.add("present")
              : e < i
              ? (t.classList.add(a ? "future" : "past"), A.fragments && Ge(t))
              : e > i
              ? (t.classList.add(a ? "past" : "future"), A.fragments && Qe(t))
              : e === i && A.fragments && (r ? Qe(t) : o && Ge(t));
        }
        let e = s[i],
        ...
        e.classList.add("present"),
          ...
          t || Te({ target: e, type: "visible", bubbles: !1 });
    ...
    function Ze() {
      ...
      if (a && void 0 !== c) {
        const n = de.isActive();
        let r = n ? 10 : A.viewDistance;
        u && (r = n ? 6 : A.mobileViewDistance),
          oe.isActive() && (r = Number.MAX_VALUE);
        for (let o = 0; o < a; o++) {
          let l = s[o],
            d = t(l, "section"),
            u = d.length;
          if (
            ((e = Math.abs((c || 0) - o) || 0),
            A.loop && (e = Math.abs(((c || 0) - o) % (a - r)) || 0),
            e < r ? te.load(l) : te.unload(l),
            u)
          ) {
            let t = n ? 0 : Fe(l);
            for (let s = 0; s < u; s++) {
              let a = d[s];
              (i = o === (c || 0) ? Math.abs((h || 0) - s) : Math.abs(s - t)),
                e + i < r ? te.load(a) : te.unload(a);
            }
          }
        }
        ot()
    ...
    function et({ includeFragments: e = !1 } = {}) {
      ...
      if ((ut(), v && !1 !== A.autoSlide)) {
        ...
        i
          ...
          !G ||
            ...
            Ke() ||
            de.isActive() ||
            (Ve() && !le.availableRoutes().next && !0 !== A.loop) ||
            ((Q = setTimeout(() => {
    ...
    function vt() {
      G && ee && ((ee = !1), Te({ type: "autoslideresumed" }), ht());
    }
    function pt({ skipFragments: e = !1 } = {}) {
      ...
      A.rtl
        ? (de.isActive() || e || !1 === le.next()) &&
          et().left &&
          $e(c + 1, "grid" === A.navigationMode ? h : void 0)
      ...
      if (e || !1 === le.prev())
        if (et().up) ft({ skipFragments: e });
          ...
          if (
            ...
            $e(c - 1, e);
          } else A.rtl ? mt({ skipFragments: e }) : pt({ skipFragments: e });
        }
    }
    function wt({ skipFragments: e = !1 } = {}) {
      ...
      if (e || !1 === le.next()) {
        let t = et();
        t.down && t.right && A.loop && qe() && (t.down = !1),
          t.down
            ? yt({ skipFragments: e })
            : A.rtl
            ? pt({ skipFragments: e })
    ...
    function Et(e) {
      ...
      if (
        ...
        if (!1 === b.test(t.method)) {
          ...
          Ie("callback", { method: t.method, result: e });
        } else
          console.warn(
            'reveal.js: "' +
              t.method +
    ...
    const xt = {
      ...
      destroy: function () {
        (H = !1),
          !1 !== q &&
            ...
            document.removeEventListener("visibilitychange", kt, !1),
            window.removeEventListener("message", Et, !1),
      ...
      toggleAutoSlide: function (e) {
        "boolean" == typeof e ? (e ? vt() : gt()) : ee ? vt() : gt();
      },
      ...
      addEventListeners: ke,
      removeEventListeners: Le,
      dispatchEvent: Te,
      getState: ct,
      setState: function (e) {
        if ("object" == typeof e) {
          $e(s(e.indexh), s(e.indexv), s(e.indexf));
          let t = s(e.paused),
            i = s(e.overview);
          "boolean" == typeof t && t !== Ke() && je(t),
      ...
      setCurrentScrollPage: function (e, t, i) {
        ...
        (g = v),
          (v = e),
          v && g && A.autoAnimate && Xe(g, v, s, h) && ae.run(g, v),
          a &&
            (g &&
    ...
    return (
      e(l, {
        ...
        onUserInput: function (e) {
          A.autoSlideStoppable && gt();
        },
        closeOverlay: me.close.bind(me),
        updateSlidesVisibility: Ze,
